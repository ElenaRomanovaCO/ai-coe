...
**Wave 6 acceptance:** Generate client report PDF → community hub functional → contribute + curate flow → onboarding personalizes → certifications earnable → analytics renders. (24b Trainings is expedited live ahead of the rest of the wave — agent-free curated catalog.)
