...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "module-7", label: "Tools Repository", wave: 4, icon: Wrench, enabled: false, purpose: "Tool & framework recommendations." },
      { id: "module-13", label: "Vendor & Model Eval", wave: 4, icon: Boxes, enabled: false, purpose: "Compare vendors and models." },
